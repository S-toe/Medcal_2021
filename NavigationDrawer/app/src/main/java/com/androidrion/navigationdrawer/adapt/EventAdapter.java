package com.androidrion.navigationdrawer.adapt;
...
import com.androidrion.navigationdrawer.R;

import java.util.List;

public class EventAdapter extends RecyclerView.Adapter<com.androidrion.navigationdrawer.adapt.EventAdapter.ViewHolder> {
    Context context;
