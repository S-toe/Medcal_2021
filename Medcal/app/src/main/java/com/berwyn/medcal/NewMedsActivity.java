...
import com.berwyn.medcal.database.DatabaseClass;
import com.berwyn.medcal.database.EntityClass;
...
public class NewMedsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_meds);
