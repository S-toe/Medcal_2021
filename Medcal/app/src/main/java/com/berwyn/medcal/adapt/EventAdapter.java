package com.berwyn.medcal.adapt;
...
import com.berwyn.medcal.R;

import java.util.List;

public class EventAdapter extends RecyclerView.Adapter<com.berwyn.medcal.adapt.EventAdapter.ViewHolder> {
    Context context;
